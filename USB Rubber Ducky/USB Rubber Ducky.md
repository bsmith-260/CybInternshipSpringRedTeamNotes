The `USB Rubber Ducky` is a malicious USB device used as a [[Keystroke Injection]] tool that uses a scripting language called [[DuckyScript]]. It works as a device that mimics a standard USB keyboard (USB HID). 
