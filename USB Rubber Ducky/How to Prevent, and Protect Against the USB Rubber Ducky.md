...
* An incident response plan ensures there is a clear process for what to do if a suspicious USB attack is suspected, such as isolating the device, collecting logs, resetting credentials, and investigating what executed.